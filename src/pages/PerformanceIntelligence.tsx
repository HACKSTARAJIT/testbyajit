    ...
    <div className="space-y-6" ref={exportRef}>
      <header className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          <Button asChild size="icon" variant="ghost" aria-label="Back"><Link to="/smart-revision" aria-label="Back to Smart Revision"><ArrowLeft className="h-4 w-4" /></Link></Button>
