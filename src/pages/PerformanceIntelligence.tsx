  ...
  if (!reports.length) {
    return (
      <Card className="border-dashed"><CardContent className="flex flex-col items-center gap-3 py-16 text-center">
        ...
        <Button asChild><Link to="/ai-performance-center">Go to AI Mock Analyzer</Link></Button>
      </CardContent></Card>
    );
  }
    ...
    <div className="space-y-6" ref={exportRef}>
      <header className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          <Button asChild size="icon" variant="ghost" aria-label="Back"><Link to="/ai-performance-center" aria-label="Back to AI Mock Analyzer"><ArrowLeft className="h-4 w-4" /></Link></Button>
