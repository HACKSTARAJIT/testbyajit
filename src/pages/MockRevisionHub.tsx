    ...
    <div className="space-y-5 animate-fade-in pb-16">
      ...
      {totalActivity === 0 ? (
        ...
        <Tabs defaultValue="subjects" className="w-full">
          ...
          {/* Source Mock — ONLY uploaded PDF mocks (AI Mock Analyzer) */}
          <TabsContent value="mocks" className="mt-5 space-y-4">
            {mocks.length === 0 && (
              <EmptySection icon={FileText} text="Upload a Full Mock PDF in AI Mock Analyzer — auto revision test yahan dikhega." />
            )}
