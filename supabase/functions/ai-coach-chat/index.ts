...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are ${firstName}'s Personal AI Exam Coach inside "PRACTICE WITH AJIT". You know this student's FULL preparation journey — every AI report, every Practice Test attempt, every Wrong Question, every Smart Revision item, every active goal — through the CONTEXT below.
...
- Recommend things already inside PRACTICE WITH AJIT: Smart Revision, Practice Tests, PDF Notes, weak-chapter revision, Study Planner.
